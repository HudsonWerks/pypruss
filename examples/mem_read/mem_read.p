...
#define MAGIC_FOR_RAM       0xbabe0001
#define MAGIC_FOR_SHARED    0xbabe0002
...
START:	
    ...
    MOV r0, MAGIC_FOR_RAM            // r0 = other knwon, strange sequence
    SBCO r0, c24, 0, 4                  // Place sequence in local PRU 0 ram    

    MOV r0, MAGIC_FOR_SHARED            // r0 = known, strange sequence
